...
Syllable structures are how syllables are composed. They're a string of characters, where each character represents a phoneme class (Consonant, Vowel, Fricative, Liquid, Sonorant).
